...
const Important = () => {
	return (
		<section id='important'>
				<h3 className='text-3xl font-semibold text-center text-black sm:mb-14 mb-5 sm:text-5xl lg:text-7xl w-[80vw] mx-auto'>Чому це важливо <span className='text-orange'>?</span></h3>
			...
			<div
				...
				<div className='max-w-4xl'>
					...
					<div
						className='items-stretch hidden max-w-4xl py-5 mt-4 text-center text-black bg-white bg-opacity-60 md:flex rounded-e-xl'>
