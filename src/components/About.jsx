    ...
    >
      ...
      <div className="flex flex-col  gap-3 items-stretch md:flex-row py-5 text-sm text-white rounded sm:rounded-lg px-2 md:pl-5 md:pr-2.5 md:pt-10 md:pb-7 sm:text-base sm:leading-6 bg-green">
        ...
        <div className="flex flex-col flex-1 gap-5">
          ...
          <p className="hidden md:block">
            118 бригада відсуває загарбників на південь все далі. Передовими
            підрозділами рухаються коригувальникі артилерії.
          </p>
          <p>
            Головна мета підрозділу коригування артилерії: збільшення
            ефективності нашого вогню. Щоб вже з другого-третього пострілу
            снаряди лягали точно в ціль. Щоб не втрачати дарма дорогоцінні
            снаряди. Щоб вороги покотились назад, у пекло.
          </p>
        </div>
      </div>
    </section>
