	...
	return (
		<section className="block w-[90vw] max-w-4xl mx-auto md:w-full md:px-5 mb-14 md:mb-11">
			<div className='flex items-center gap-2.5 mb-5 md:mb-14 sm:gap-5 mb-14'>
				<h2 className='text-3xl font-semibold text-black sm:text-7xl'>Про бригаду</h2> 
				<img className='h-10 sm:h-28' src={logo} alt='logo' />
			</div>
			<div className='flex flex-col  gap-3 items-center md:flex-row py-5 text-sm text-white rounded sm:rounded-lg px-2 md:pl-5 md:pr-2.5 md:pt-10 md:pb-6 sm:text-base sm:leading-6 bg-green'>
				...
				<div className='md:h-96'>
					<img className='object-cover h-full' src={aboutImgMob} alt="aboutImg" />
				</div>	
